...
from uie_collator_ABSA import DataCollatorForUIE
from uie_dataset_ABSA import gen_cache_path

from uie_trainer_ABSA import UIETrainer, DenserEvalCallback, skip_instructions
...
class DataTrainingArguments:
    ...
    test_format: Optional[str] = field(
        default="test",
        metadata={"help": "Test Format, choose:[test, RevNon, RevTgt, AddDiff]"}
    )
...
def main():
    ...
    raw_datasets = load_dataset(
        os.path.join(CURRENT_DIR, "uie_dataset_ABSA.py"),
        ...
        test_format=data_args.test_format
    )
